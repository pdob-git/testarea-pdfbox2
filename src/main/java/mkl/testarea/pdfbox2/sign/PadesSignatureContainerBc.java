 ...
 * </a>
 * <p>
 * This {@link SignatureInterface} implementation generates a CAdES signature
 * container that can be used to create PAdES BASELINE B or T signatures.
 * It is a trivial port of the iText 7 <code>IExternalSignatureContainer</code>
 * implementation with the same name in the iText7 test area.
 * </p>
 * @author mkl
 */
